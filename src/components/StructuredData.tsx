...
const OrganizationSchema = () => {
  const schema = {
    ...
    description:
      "Custom software solutions — websites, web apps & AI tools with bespoke UI/UX design and ISTQB-certified Quality Assurance. Your 1-month project, delivered in several days. Serving clients worldwide.",
    slogan:
    ...
    serviceType: [
      ...
      "Κατασκευή Προσωπικής Ιστοσελίδας Portfolio",
      "Persönliche Portfolio-Website",
      "Personal Brand & CV Website Design",
