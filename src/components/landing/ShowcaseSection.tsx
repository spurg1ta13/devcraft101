          ...
          {s.projects.map((project, i) => {
            ...
            return (
              <motion.div
                ...
                className="group cursor-pointer relative overflow-hidden bg-secondary border border-border/50 rounded-3xl p-6 sm:p-8 lg:p-10 group-hover:border-primary/40 transition-all duration-700 flex flex-col justify-between min-h-[380px] sm:min-h-[420px] hover:shadow-glow"
              >
