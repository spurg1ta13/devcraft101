          ...
          {p.steps.map((step, i) => {
            ...
            return (
              <motion.article
                ...
                className="group relative overflow-hidden bg-secondary border border-border/50 rounded-2xl md:rounded-3xl p-6 sm:p-8 md:p-12 hover:border-primary/30 hover:shadow-[0_0_40px_-8px_hsl(38_100%_55%/0.25)] transition-all duration-700 min-h-[240px] md:min-h-[280px]"
              >
