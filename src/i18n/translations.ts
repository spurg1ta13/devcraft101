...
export const translations = {
  // Navbar
  nav: {
    aboutUs: { en: "About Us", el: "Σχετικά", de: "Über uns" },
    services: { en: "Services", el: "Υπηρεσίες", de: "Leistungen" },
    work: { en: "Our Projects", el: "Τα Έργα μας", de: "Unsere Projekte" },
    blog: { en: "Blog", el: "Ιστολόγιο", de: "Blog" },
    pricing: { en: "Plans", el: "Πακέτα", de: "Pläne" },
    contact: { en: "Contact", el: "Επικοινωνία", de: "Kontakt" },
    letsTalk: { en: "Let's talk", el: "Επικοινωνήστε", de: "Lassen Sie uns sprechen" },
  },

  // Hero
  hero: {
    line1: { en: "We don't do", el: "Δεν κάνουμε", de: "Das tun wir nicht." },
  ...
  marquee: {
    words: {
      ...
      el: ["Ανάπτυξη Ιστοσελίδων", "Σχεδιασμός UI/UX", "Δοκιμές ISTQB", "React", "TypeScript", "Απόδοση", "Συστήματα Σχεδιασμού", "Διασφάλιση Ποιότητας", "Αρχιτεκτονική API", "Cloud Deploy", "Προσβασιμότητα", "Ελέγχοι Ασφαλείας", "Ψηφιακό Marketing"], de: ["Webentwicklung", "UI/UX Design", "ISTQB-Testphasen", "React", "TypeScript", "Performance", "Design Systeme", "Qualitätssicherung", "API-Architektur", "Cloud Deploy", "Barrierefreiheit", "Sicherheitsaudits", "Digitales Marketing"],
    },
  },

  // Services
  services: {
    label: { en: "What we do", el: "Τι κάνουμε", de: "Was wir tun" },
    heading1: { en: "Design, Development", el: "Σχεδιασμός, Ανάπτυξη", de: "Design, Entwicklung" },
    heading2: { en: "& Quality Testing.", el: "& Ποιοτικός Έλεγχος.", de: "& Qualitätssicherung." },
    items: [
      {
        title: { en: "Development", el: "Ανάπτυξη", de: "Entwicklung" },
        scope: { en: "Full-Stack Web Applications", el: "Full-Stack Εφαρμογές Ιστού", de: "Full-Stack Webanwendungen" },
        description: {
      ...
      {
        title: { en: "Design", el: "Σχεδιασμός", de: "Design" },
        scope: { en: "Custom UI/UX Interfaces", el: "Εξατομικευμένες Διεπαφές UI/UX", de: "Benutzerdefinierte UI/UX-Oberflächen" },
        description: {
      ...
      {
        title: { en: "Quality", el: "Ποιότητα", de: "Qualität" },
        scope: { en: "ISTQB-Certified Testing", el: "Πιστοποιημένες Δοκιμές ISTQB", de: "ISTQB-zertifiziertes Testen" },
        description: {
      ...
      {
        title: { en: "Marketing", el: "Marketing", de: "Marketing" },
        scope: { en: "Strategic Digital Growth", el: "Strategic Digital Growth", de: "Strategisches digitales Wachstum" },
        description: {
    ...
    buildLabel: { en: "What we can build", el: "Τι μπορούμε να φτιάξουμε", de: "Was wir bauen können" },
    buildHeading1: { en: "Solutions", el: "Λύσεις", de: "Lösungen" },
    buildHeading2: { en: "tailored to your goals.", el: "προσαρμοσμένες στους στόχους σας.", de: "zugeschnitten auf Ihre Ziele." },
    builds: [
      {
        title: { en: "SaaS Platforms", el: "Πλατφόρμες SaaS", de: "SaaS-Plattformen" },
        description: {
      ...
      {
        title: { en: "Booking & Scheduling Systems", el: "Συστήματα Κρατήσεων & Προγραμματισμού", de: "Buchungs- & Planungssysteme" },
        description: {
      ...
      {
        title: { en: "High-Conversion Landing Pages", el: "Landing Pages Υψηλής Μετατροπής", de: "Landingpages mit hoher Conversion-Rate" },
        description: {
      ...
      {
        title: { en: "Corporate / Representative Pages", el: "Εταιρικές / Αντιπροσωπευτικές Σελίδες", de: "Unternehmens-/Repräsentative Seiten" },
        description: {
      ...
      {
        title: { en: "Custom CRM & Internal Tools", el: "Custom CRM & Εσωτερικά Εργαλεία", de: "Benutzerdefiniertes CRM & Interne Tools" },
        description: {
      ...
      {
        title: { en: "Digital Guest Portals", el: "Ψηφιακά Portals Επισκεπτών", de: "Digitale Gästemappen" },
        description: {
      ...
      {
        title: { en: "Specialized Booking Engines", el: "Εξειδικευμένες Μηχανές Κρατήσεων", de: "Spezialisierte Buchungsmaschinen" },
        description: {
    ...
    customCtaTitle: { en: "Need a custom solution?", el: "Χρειάζεστε εξατομικευμένη λύση;", de: "Benötigen Sie eine maßgeschneiderte Lösung?" },
    customCtaText: {
  ...
  // Showcase
  showcase: {
    label: { en: "Selected work", el: "Επιλεγμένα έργα", de: "Ausgewählte Arbeiten" },
    heading1: { en: "Project quality", el: "Ποιότητα project", de: "Projektqualität" },
    heading2: { en: "speaks louder.", el: "που μιλάει μόνη της.", de: "spricht Bände." },
    projects: [
      {
        title: { en: "Seamless Experience", el: "Απρόσκοπτη Εμπειρία", de: "Nahtloses Erlebnis" },
        tag: { en: "Responsive & Cross-Platform", el: "Responsive & Cross-Platform", de: "Responsiv & Pluralformübergreifend" },
        description: {
      ...
      {
        title: { en: "ISTQB Certified Quality", el: "Πιστοποιημένη Ποιότητα ISTQB", de: "ISTQB Certified Quality" },
        tag: { en: "Defects Policy", el: "Πολιτική Σφαλμάτων", de: "Fehlerpolitik" },
        description: {
      ...
      {
        title: { en: "Custom Design Solutions", el: "Εξατομικευμένες Λύσεις Σχεδιασμού", de: "Maßgeschneiderte Designlösungen" },
        tag: { en: "UI/UX Excellence", el: "Αριστεία UI/UX", de: "UI/UX Exzellenz" },
        description: {
  ...
  // Process
  process: {
    label: { en: "How it works", el: "Πώς λειτουργεί", de: "So funktioniert's" },
    heading1: { en: "Four steps.", el: "Τέσσερα βήματα.", de: "Vier Schritte." },
    heading2: { en: "Zero surprises.", el: "Μηδέν εκπλήξεις.", de: "Keine Überraschungen." },
    steps: [
      { title: { en: "Discover", el: "Ανακάλυψη", de: "Entdecken Sie" }, desc: { en: "Goals, users, constraints. We go deep before we go wide.", el: "Στόχοι, χρήστες, περιορισμοί. Εμβαθύνουμε πριν επεκταθούμε.", de: "Ziele, Benutzer, Einschränkungen. Wir gehen in die Tiefe, bevor wir in die Breite gehen." } },
      { title: { en: "Design", el: "Σχεδιασμός", de: "Design" }, desc: { en: "Wireframes → prototypes → pixel-perfect UI. You approve every step.", el: "Wireframes → πρωτότυπα → pixel-perfect UI. Εγκρίνετε κάθε βήμα.", de: "Wireframes → Prototypen → pixelgenaue UI. Sie genehmigen jeden Schritt." } },
      { title: { en: "Build", el: "Κατασκευή", de: "Erstellen" }, desc: { en: "Agile sprints, clean code, weekly demos. Full transparency.", el: "Agile sprints, καθαρός κώδικας, εβδομαδιαίες παρουσιάσεις. Πλήρης διαφάνεια.", de: "Agile Sprints, sauberer Code, wöchentliche Demos. Volle Transparenz." } },
      { title: { en: "Ship", el: "Παράδοση", de: "Versand" }, desc: { en: "ISTQB-certified QA, performance tuning, and a flawless launch.", el: "Πιστοποιημένη QA ISTQB, βελτιστοποίηση απόδοσης και άψογη κυκλοφορία.", de: "ISTQB-zertifizierte Qualitätssicherung, Performance-Optimierung und ein reibungsloser Launch." } },
    ],
  },

  // FAQ
  faq: {
    label: { en: "FAQ", el: "Συχνές Ερωτήσεις", de: "Häufig gestellte Fragen (FAQ)" },
    heading1: { en: "Common", el: "Συχνές", de: "Allgemein" },
    heading2: { en: "questions", el: "ερωτήσεις", de: "Fragen" },
    items: [
      {
        question: { en: "What technologies do you use for web development?", el: "Ποιες τεχνολογίες χρησιμοποιείτε για την ανάπτυξη ιστοσελίδων;", de: "Welche Technologien nutzen Sie für die Webentwicklung?" },
        answer: {
      ...
      {
        question: { en: "Do you offer ongoing support after launch?", el: "Προσφέρετε συνεχή υποστήριξη μετά την κυκλοφορία;", de: "Bieten Sie fortlaufenden Support nach der Einführung an?" },
        answer: {
      ...
      {
        question: { en: "What does ISTQB-certified testing mean for my project?", el: "Τι σημαίνει η πιστοποιημένη δοκιμή ISTQB για το έργο μου;", de: "Was bedeutet ISTQB-zertifiziertes Testen für mein Projekt?" },
        answer: {
      ...
      {
        question: { en: "Can you redesign or improve an existing website?", el: "Μπορείτε να ανασχεδιάσετε ή να βελτιώσετε μια υπάρχουσα ιστοσελίδα;", de: "Möchten Sie eine bestehende Website neugestalten oder verbessern?" },
        answer: {
      ...
      {
        question: { en: "How do you handle communication during a project?", el: "Πώς διαχειρίζεστε την επικοινωνία κατά τη διάρκεια ενός έργου;", de: "Wie läuft die Kommunikation während eines Projekts ab?" },
        answer: {
      ...
      {
        question: { en: "Do you use AI in your development process?", el: "Χρησιμοποιείτε τεχνητή νοημοσύνη στη διαδικασία ανάπτυξης;", de: "Nutzen Sie KI in Ihrem Entwicklungsprozess?" },
        answer: {
      ...
      {
        question: { en: "What digital marketing services do you provide?", el: "Ποιες υπηρεσίες digital marketing προσφέρετε;", de: "Welche digitalen Marketingdienstleistungen bieten Sie an?" },
        answer: {
      ...
      {
        question: { en: "How long does it take to see results from SEO and digital marketing?", el: "Πόσο χρόνο χρειάζεται για να φανούν αποτελέσματα από SEO και digital marketing;", de: "Wie lange dauert es, bis sich Ergebnisse aus SEO und digitalem Marketing zeigen?" },
        answer: {
  ...
  cta: {
    label: { en: "Next step", el: "Επόμενο βήμα", de: "Nächster Schritt" },
    heading1: { en: "Got a project?", el: "Έχετε ένα έργο;", de: "Haben Sie ein Projekt?" },
    heading2: { en: "Let's talk.", el: "Ας μιλήσουμε.", de: "Lassen Sie uns reden." },
    description: {
    ...
    phone: { en: "Phone number", el: "Τηλέφωνο", de: "Telefonnummer" },
    message: { en: "Tell us about your project...", el: "Πείτε μας για το έργο σας...", de: "Erzählen Sie uns von Ihrem Projekt..." },
    agree: { en: "I agree to the", el: "Συμφωνώ με την", de: "Ich stimme zu den" },
    privacyPolicy: { en: "Privacy Policy", el: "Πολιτική Απορρήτου", de: "Datenschutzerklärung" },
    respond: { en: "We respond within 48 hours", el: "Απαντάμε εντός 48 ωρών", de: "Wir antworten innerhalb von 48 Stunden" },
    send: { en: "Send message", el: "Αποστολή μηνύματος", de: "Nachricht senden" },
    successTitle1: { en: "Message", el: "Μήνυμα", de: "Nachricht" },
    successTitle2: { en: "sent!", el: "εστάλη!", de: "gesendet!" },
    successDesc: { en: "We'll get back to you within 48 hours.", el: "Θα επικοινωνήσουμε μαζί σας εντός 48 ωρών.", de: "Wir melden uns innerhalb von 48 Stunden bei Ihnen." },
    errors: {
      nameRequired: { en: "Name is required", el: "Το όνομα είναι υποχρεωτικό", de: "Name ist erforderlich" },
      nameMax: { en: "Max 100 characters", el: "Μέγιστο 100 χαρακτήρες", de: "Max. 100 Zeichen" },
      contactRequired: { en: "Please provide either an email or phone number", el: "Παρακαλώ δώστε email ή τηλέφωνο", de: "Bitte geben Sie eine E-Mail-Adresse oder Telefonnummer an" },
      invalidEmail: { en: "Invalid email", el: "Μη έγκυρο email", de: "Ungültige E-Mail-Adresse" },
      invalidPhone: { en: "Invalid phone number", el: "Μη έγκυρος αριθμός τηλεφώνου", de: "Ungültige Telefonnummer" },
      messageRequired: { en: "Message is required", el: "Το μήνυμα είναι υποχρεωτικό", de: "Nachricht ist erforderlich" },
      messageMax: { en: "Max 1000 characters", el: "Μέγιστο 1000 χαρακτήρες", de: "Max. 1000 Zeichen" },
      privacyRequired: { en: "You must agree to the Privacy Policy", el: "Πρέπει να συμφωνήσετε με την Πολιτική Απορρήτου", de: "Sie müssen der Datenschutzerklärung zustimmen" },
    },
    booking: {
      toggleMessage: { en: "Send a message", el: "Στείλτε μήνυμα", de: "Nachricht senden" },
      toggleBooking: { en: "Book a meeting", el: "Κλείστε ραντεβού", de: "Meeting buchen" },
      title: { en: "Book a meeting", el: "Κλείστε ένα ραντεβού", de: "Meeting buchen" },
      subtitle: {
      ...
      booking: { en: "Booking...", el: "Κράτηση...", de: "Buchung..." },
      successTitle1: { en: "Meeting", el: "Ραντεβού", de: "Besprechung" },
      successTitle2: { en: "booked!", el: "κλείστηκε!", de: "Gebucht!" },
      successDesc: {
      ...
      errors: {
        ...
        hourRequired: { en: "Please select a time slot", el: "Επιλέξτε ώρα", de: "Bitte wählen Sie einen Zeitraum aus" },
        slotTaken: { en: "This time slot was just booked. Please pick another.", el: "Αυτή η ώρα μόλις κλείστηκε. Επιλέξτε άλλη.", de: "Dieser Zeitbereich wurde gerade gebucht. Bitte wählen Sie einen anderen." },
      },
    },
  },
  ...
  footer: {
    ...
    getInTouch: { en: "Get in touch", el: "Επικοινωνία", de: "Kontaktieren Sie uns" },
    rights: { en: "All rights reserved.", el: "Με επιφύλαξη παντός δικαιώματος.", de: "Alle Rechte vorbehalten." },
    privacyPolicy: { en: "Privacy Policy", el: "Πολιτική Απορρήτου", de: "Datenschutzbestimmungen" },
    termsOfService: { en: "Terms of Service", el: "Όροι Χρήσης", de: "Nutzungsbedingungen" },
  },

  // About page
  about: {
    backToHome: { en: "Back to home", el: "Επιστροφή στην αρχική", de: "Zur Startseite" },
    heading1: { en: "About", el: "Σχετικά", de: "Über uns" },
    heading2: { en: "us.", el: "με εμάς.", de: "uns." },
    intro1: {
    ...
    stats: {
      ...
      satisfaction: { en: "Client Satisfaction", el: "Ικανοποίηση Πελατών", de: "Kundenzufriedenheit" },
      defect: { en: "Defect Policy", el: "Πολιτική Σφαλμάτων", de: "Fehlerrichtlinie" },
    },
    teamLabel: { en: "The team", el: "Η ομάδα", de: "Das Team" },
    teamHeading1: { en: "Core", el: "Βασική", de: "Kern" },
    teamHeading2: { en: "expertise.", el: "εξειδίκευση.", de: "Expertise." },
    roles: {
      webDev: { en: "Web Developer", el: "Web Developer", de: "Webentwickler" },
      webDevDesc: {
    ...
    valuesHeading2: { en: "calling card.", el: "επαγγελματική μας κάρτα.", de: "Visitenkarte." },
    valuesDesc: {
  ...
  // Privacy Policy
  privacy: {
    heading1: { en: "Privacy", el: "Πολιτική", de: "Datenschutz" },
    heading2: { en: "Policy.", el: "Απορρήτου.", de: "Richtlinie." },
    lastUpdated: { en: "Last updated:", el: "Τελευταία ενημέρωση:", de: "Zuletzt aktualisiert:" },
    sections: [
      {
      ...
      {
        title: { en: "2. Information We Collect", el: "2. Πληροφορίες που Συλλέγουμε", de: "2. Informationen, die wir sammeln" },
        content: {
      ...
      {
        title: { en: "3. Legal Basis for Processing", el: "3. Νομική Βάση Επεξεργασίας", de: "3. Rechtsgrundlage für die Verarbeitung" },
        content: {
      ...
      {
        title: { en: "4. AI Assistant & Interaction Data", el: "4. AI Βοηθός & Δεδομένα Αλληλεπίδρασης", de: "4. KI-Assistent & Interaktionsdaten" },
        content: {
...
• **AI Chat**: Wenn Sie mit unserem KI-Assistenten interagieren, wird der aus Ihrer IP abgeleitete Ländercode zusammen mit dem Chat-Protokoll zu Zwecken der internen Analyse und Missbrauchsprävention gespeichert. Er ist ausschließlich dem Website-Administrator zugänglich, wird niemals an Dritte weitergegeben und gemäß unserer Aufbewahrungsrichtlinie zusammen mit dem Chat-Protokoll aufbewahrt. Der KI-Assistent selbst erhält oder verwendet diese Information in seinen Antworten nicht.`,
  ...
  // Terms of Service
  terms: {
    heading1: { en: "Terms of", el: "Όροι", de: "Nutzungsbedingungen von" },
    heading2: { en: "Service", el: "Χρήσης", de: "Dienstleistung" },
    lastUpdated: { en: "Last updated:", el: "Τελευταία ενημέρωση:", de: "Zuletzt aktualisiert:" },
    sections: [
      {
        title: { en: "1. Acceptance of Terms", el: "1. Αποδοχή Όρων", de: "1. Annahme der Bedingungen" },
        content: {
      ...
      {
        title: { en: "2. Services Description", el: "2. Περιγραφή Υπηρεσιών", de: "2. Leistungsbeschreibung" },
        content: {
      ...
      {
        title: { en: "3. Intellectual Property", el: "3. Πνευματική Ιδιοκτησία", de: "3. Geistiges Eigentum" },
        content: {
      ...
      {
        title: { en: "4. User Conduct", el: "4. Συμπεριφορά Χρήστη", de: "4. Nutzerverhalten" },
        content: {
      ...
      {
        title: { en: "5. Project Agreements", el: "5. Συμφωνίες Έργου", de: "5. Projektvereinbarungen" },
        content: {
      ...
      {
        title: { en: "6. Limitation of Liability", el: "6. Περιορισμός Ευθύνης", de: "6. Haftungsbeschränkung" },
        content: {
      ...
      {
        title: { en: "7. Warranties and Disclaimers", el: "7. Εγγυήσεις και Αποποιήσεις", de: "7. Garantien und Haftungsausschlüsse" },
        content: {
      ...
      {
        title: { en: "9. Changes to Terms", el: "9. Αλλαγές στους Όρους", de: "9. Änderungen der Bedingungen" },
        content: {
  ...
  cookie: {
    ...
    decline: { en: "Decline", el: "Απόρριψη", de: "Ablehnen" },
  },

  // Portfolio
  portfolio: {
    label: { en: "Our", el: "Τα Έργα", de: "Unsere" },
    label2: { en: "Projects", el: "μας", de: "Projekte" },
    subtitle: {
    ...
    projects: [
      ...
      {
        title: { en: "Luxe Ellada", el: "Luxe Ellada", de: "Luxe Ellada" },
        category: { en: "Premium Web Platform", el: "Premium Πλατφόρμα", de: "Premium Web-Plattform" },
        description: {
      ...
      {
        title: { en: "Dental Care", el: "Dental Care", de: "Zahnpflege" },
        category: { en: "Professional Website", el: "Επαγγελματική Ιστοσελίδα", de: "Professionelle Website" },
        description: {
      ...
      {
        title: { en: "Premium Real Estate", el: "Premium Real Estate", de: "Premium-Immobilien" },
        category: { en: "Web Application", el: "Web Εφαρμογή", de: "Webanwendung" },
        description: {
  ...
  pricing: {
    ...
    plans: [
      {
        name: { en: "MINI", el: "MINI", de: "MINI" },
        tagline: { en: "The Clean Start", el: "Καθαρή Αρχή", de: "Der saubere Start" },
        bestFor: {
        ...
        features: {
          ...
          el: [
            ...
            "Datenschutzbestimmungen & Allgemeine Geschäftsbedingungen automatisch generiert",
            "GDPR & Cookie-Compliance",
            "Schnelles Laden (Mobil & Desktop)",
            "SSL-Sicherheitszertifikat",
          ],
        },
      },
      {
        name: { en: "MIDI", el: "MIDI", de: "MIDI" },
        tagline: { en: "The Corporate Standard", el: "Εταιρικό Στάνταρ", de: "Der Unternehmensstandard" },
        bestFor: {
        ...
        features: {
          ...
          el: [
            ...
            "Bis zu 5 Seiten",
            "1 Sprache",
            "Galerie & Portfolio-Präsentation",
            "Direkte Kontaktmöglichkeiten (E-Mail & Telefon)",
            "Technisches SEO-Setup (Sitemap, Meta-Tags, Indexierung)",
            "Datenschutzbestimmungen und Nutzungsbedingungen automatisch generiert",
            "DSGVO & Cookie-Konformität",
            "Google Maps-Integration",
            "Schwebender Viber/WhatsApp-Button (Mobil)",
            "Google Maps & Suchmaschinenoptimierung",
            "Erweitertes lokales SEO (Roboterfreundliche Daten)",
            "Schnelles Laden (Mobil & Desktop)",
            "SSL-Sicherheitszertifikat",
          ],
        },
      ...
      {
        name: { en: "MAXI", el: "MAXI", de: "MAXI" },
        tagline: { en: "The International Presence", el: "Διεθνής Παρουσία", de: "Die internationale Präsenz" },
        bestFor: {
        ...
        features: {
          ...
          el: [
            ...
            "Bis zu 7 Seiten",
            "2–3 Sprachen mit Umschalter",
            "Lead-Erfassungsformular mit Spam-Schutz",
            "Galerie & Portfolio",
            "Lokalisiertes SEO pro Sprache",
            "Technisches SEO-Setup (Sitemap, Meta-Tags, Indexierung)",
            "Benutzerdefinierte Fehler- und Ladeseiten",
            "Admin-Dashboard für Nachrichten",
            "Datenschutzrichtlinie und Allgemeine Geschäftsbedingungen (autom. generiert)",
            "DSGVO & Cookie-Compliance",
            "Google Maps-Integration",
            "Viber/WhatsApp Floating Button (Mobil)",
            "Google Maps & Suchmaschinenoptimierung",
            "Erweitertes lokales SEO (roboterfreundliche Daten)",
            "Werbetexte",
      ...
      {
        name: { en: "ELITE", el: "ELITE", de: "ELITE" },
        tagline: { en: "The Elite Performance", el: "Ελίτ Απόδοση", de: "Die Elite-Performance" },
        bestFor: {
        ...
        features: {
          ...
          el: [
            ...
            "Bis zu 10 Seiten + interaktive Tools",
            "Unbegrenzte Sprachen",
            "KI-Assistenten-Integration",
            "Lead- und Buchungsformular mit Spam-Schutz",
            "Benutzerdefinierte Animationen & Effekte",
            "Automatische Bildoptimierung",
            "SEO-optimierte URL-Struktur",
            "Technisches SEO-Setup (Sitemap, Meta-Tags, Indexierung)",
            "Benutzerdefinierte Fehler- und Ladeseiten",
            "Admin-Dashboard für Nachrichten und Buchungen",
            "Datenschutzrichtlinie und Allgemeine Geschäftsbedingungen (AGB) automatisch generiert",
            "DSGVO & Cookie-Compliance",
            "Google Maps Integration",
            "Viber/WhatsApp Floating Button (Mobil)",
            "Google Maps & Suchmaschinenoptimierung",
            ...
            "Texterstellung",
            "Barrierefreiheit (WCAG-Konformität)",
            "Schnelle Ladezeiten (Mobil & Desktop)",
            "Qualitätssicherung (ISTQB Certified)",
            "SSL-Sicherheitszertifikat",
          ],
        },
      },
    ],
    vatNote: { en: "*Prices do not include VAT", el: "*Οι τιμές δεν περιλαμβάνουν ΦΠΑ", de: "*Preise verstehen sich zzgl. MwSt." },
    deliveryNote: { en: "*Delivery starts after all content is received", el: "*Η παράδοση ξεκινά μετά τη λήψη όλου του περιεχομένου", de: "*Die Lieferung beginnt, nachdem alle Inhalte empfangen wurden" },
